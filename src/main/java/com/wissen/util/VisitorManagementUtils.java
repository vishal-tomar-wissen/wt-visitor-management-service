...
public class VisitorManagementUtils {
	...
	public static Set<String> getAllowedVisitorFilterField() {
		return Sets.newHashSet("visitorId", "fullName", "email", "phoneNumber", "idProofType", "idProofNumber",
				"tempCardNo");
	}
	...
	public static Set<String> getAllowedTimingFilterField() {
		return Sets.newHashSet(Constants.IN_TIME_COLUMN, Constants.OUT_TIME_COLUMN, Constants.EMPLOYEE_ID_COLUMN,
				Constants.VISITOR_TYPE_COLUMN);
	}
